...
CONTEXT_FILE = 'data/env_context_file.txt' # file that provides training data
RAW_DATA_FILE = 'data/env_raw_data.txt' # file that provides raw data
OUTPUT_FILE = '../http_request/data/env_output.txt' #file that writes gpt response (overwrite)
